# Callor Word Master — 1단계 최종 패키지 v0.1.8
...
- 생명 소진 시 최종 점수·클리어 수를 보여주는 게임 오버와 즉시 재시작
- 탭 또는 창을 벗어나면 자동 일시정지
- 소리·폭발 효과 선택과 브라우저 전체화면, 모든 설정의 기기 저장
- 최초 실행 게임 방법 안내와 도움말 다시 보기
- 모바일 정답 완료 진동 피드백(지원 기기)
- 회화 기본 단어 200개
