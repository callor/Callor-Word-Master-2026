...
export function WordGame() {
  ...
  return (
    <main className="app-shell">
      ...
      <footer className="footer-note"><span>CopyRight HanQube Solution</span><i /><a href="mailto:callor@callor.com">callor@callor.com</a><b>Callor Word Master v0.1.6</b></footer>
    </main>
  );
}
