# Callor Word Master — 1단계 패키지 v0.1.7
...
- PC 화면을 좌측 브랜드·중앙 게임·우측 상태의 독립적인 3열 구조로 변경
- 좌우 패널과 낙하 영역이 겹치지 않아 단어 가림 현상 제거
- 화면 폭에 따라 좌우 열은 제한적으로 조정하고 중앙 게임 영역에 남은 폭을 모두 배정
